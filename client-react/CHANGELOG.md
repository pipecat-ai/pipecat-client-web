...
All notable changes to **Pipecat Client React** will be documented in this file.
...
* **react:** stop bundling client-js types into the published d.ts ([#239](https://github.com/pipecat-ai/pipecat-client-web/issues/239)) ([7b1e97e](https://github.com/pipecat-ai/pipecat-client-web/commit/7b1e97e9dc503d5ee6999cd3603cd129fa947535))
...
* **react:** Fixing automated tests ([3a5afc2](https://github.com/pipecat-ai/pipecat-client-web/commit/3a5afc2598c503b3eb4138d9826eeba875143a83))
* **react:** Fixing automated tests ([8996471](https://github.com/pipecat-ai/pipecat-client-web/commit/8996471c443f8f329523aa3de24bd8b8d2fb0c8e))
...
* **react:** add useMediaState hook and autoInitDevices opt-in ([d6e6ef3](https://github.com/pipecat-ai/pipecat-client-web/commit/d6e6ef3f732d12c0876f5a5f36f313bfc211a08f))
